...
def get_company_list() -> list():
    companies = [CompanyItem("kraken", "https://jobs.lever.co/kraken", ScrapeLever, "https://kraken.com", "Exchange"),
...
def get_logo(company_name):
    company_logos = {
        ...
        'stellar': '<img src="resources/stellar.png" alt="Stellar" loading="lazy" width="182" height: auto >',
        'sygnum': '<img src="resources/sygnum.png" alt="Sygnum" loading="lazy" width="182" height: auto >',
        'okcoin': '<img src="resources/okcoin.png" alt="Okcoin" loading="lazy" width="182" height: auto >',
        'matterlabs': '<img src="resources/matterlabs.png" alt="Matterlabs" loading="lazy" width="182" height: auto >',
